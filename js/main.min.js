...
var canvas_benefit,stage_benefit,exportRoot_benefit,anim_container_benefit,dom_overlay_container_benefit,fnStartAnimation_benefit,canvas_car,stage_car,exportRoot_car,anim_container_car,dom_overlay_container_car,fnStartAnimation_car,canvas_commercial,stage_commercial,exportRoot_commercial,anim_container_commercial,dom_overlay_container_commercial,fnStartAnimation_commercial,canvas_flood,stage_flood,exportRoot_flood,anim_container_flood,dom_overlay_container_flood,fnStartAnimation_flood,canvas_house,stage_house,exportRoot_house,anim_container_house,dom_overlay_container_house,fnStartAnimation_house,canvas_jobs,stage_jobs,exportRoot_jobs,anim_container_jobs,dom_overlay_container_jobs,fnStartAnimation_jobs,canvas_money,stage_money,exportRoot_money,anim_container_money,dom_overlay_container_money,fnStartAnimation_money;function init_benefit(){canvas_benefit=document.getElementById("canvas_benefit"),anim_container_benefit=document.getElementById("animation_container_benefit"),dom_overlay_container_benefit=document.getElementById("dom_overlay_container_benefit");var t=AdobeAn_benefit.getComposition("9C467AB24BF8423195F44663826E4B49"),e=t.getLibrary(),o=new createjs.LoadQueue(!1);o.addEventListener("fileload",function(e){handleFileLoad_benefit(e,t)}),o.addEventListener("complete",function(e){handleComplete_benefit(e,t)});e=t.getLibrary();o.loadManifest(e.properties.manifest)}function handleFileLoad_benefit(e,t){var o=t.getImages();e&&"image"==e.item.type&&(o[e.item.id]=e.result)}function handleComplete_benefit(e,t){var o=t.getLibrary(),n=t.getSpriteSheet(),a=e.target,r=o.ssMetadata;for(i=0;i<r.length;i++)n[r[i].name]=new createjs.SpriteSheet({images:[a.getResult(r[i].name)],frames:r[i].frames});exportRoot_benefit=new o.Benefit,(stage_benefit=new o.Stage(canvas_benefit)).addChild(exportRoot_benefit),fnStartAnimation_benefit=function(){createjs.Ticker.framerate=o.properties.fps,createjs.Ticker.addEventListener("tick",stage_benefit)},AdobeAn_benefit.makeResponsive(!0,"both",!0,1,[canvas_benefit,anim_container_benefit,dom_overlay_container_benefit]),AdobeAn_benefit.compositionLoaded(o.properties.id)}function init_car(){canvas_car=document.getElementById("canvas_car"),anim_container_car=document.getElementById("animation_container_car"),dom_overlay_container_car=document.getElementById("dom_overlay_container_car");var t=AdobeAn.getComposition("9C467AB24BF8423195F44663826E4B49"),e=t.getLibrary(),o=new createjs.LoadQueue(!1);o.addEventListener("fileload",function(e){handleFileLoad_car(e,t)}),o.addEventListener("complete",function(e){handleComplete_car(e,t)});e=t.getLibrary();o.loadManifest(e.properties.manifest)}function handleFileLoad_car(e,t){var o=t.getImages();e&&"image"==e.item.type&&(o[e.item.id]=e.result)}function handleComplete_car(e,t){var o=t.getLibrary(),n=t.getSpriteSheet(),a=e.target,r=o.ssMetadata;for(i=0;i<r.length;i++)n[r[i].name]=new createjs.SpriteSheet({images:[a.getResult(r[i].name)],frames:r[i].frames});exportRoot_car=new o.Car,(stage_car=new o.Stage(canvas_car)).addChild(exportRoot_car),fnStartAnimation_car=function(){createjs.Ticker.framerate=o.properties.fps,createjs.Ticker.addEventListener("tick",stage_car)},AdobeAn.makeResponsive(!0,"both",!0,1,[canvas_car,anim_container_car,dom_overlay_container_car]),AdobeAn.compositionLoaded(o.properties.id)}function init_commercial(){canvas_commercial=document.getElementById("canvas_commercial"),anim_container_commercial=document.getElementById("animation_container_commercial"),dom_overlay_container_commercial=document.getElementById("dom_overlay_container_commercial");var t=AdobeAn_commercial.getComposition("9C467AB24BF8423195F44663826E4B49"),e=t.getLibrary(),o=new createjs.LoadQueue(!1);o.addEventListener("fileload",function(e){handleFileLoad_commercial(e,t)}),o.addEventListener("complete",function(e){handleComplete_commercial(e,t)});e=t.getLibrary();o.loadManifest(e.properties.manifest)}function handleFileLoad_commercial(e,t){var o=t.getImages();e&&"image"==e.item.type&&(o[e.item.id]=e.result)}function handleComplete_commercial(e,t){var o=t.getLibrary(),n=t.getSpriteSheet(),a=e.target,r=o.ssMetadata;for(i=0;i<r.length;i++)n[r[i].name]=new createjs.SpriteSheet({images:[a.getResult(r[i].name)],frames:r[i].frames});exportRoot_commercial=new o.Commercial,(stage_commercial=new o.Stage(canvas_commercial)).addChild(exportRoot_commercial),fnStartAnimation_commercial=function(){createjs.Ticker.framerate=o.properties.fps,createjs.Ticker.addEventListener("tick",stage_commercial)},AdobeAn_commercial.makeResponsive(!0,"both",!0,1,[canvas_commercial,anim_container_commercial,dom_overlay_container_commercial]),AdobeAn_commercial.compositionLoaded(o.properties.id)}function init_flood(){canvas_flood=document.getElementById("canvas_flood"),anim_container_flood=document.getElementById("animation_container_flood"),dom_overlay_container_flood=document.getElementById("dom_overlay_container_flood");var t=AdobeAn_flood.getComposition("9C467AB24BF8423195F44663826E4B49"),e=t.getLibrary(),o=new createjs.LoadQueue(!1);o.addEventListener("fileload",function(e){handleFileLoad_flood(e,t)}),o.addEventListener("complete",function(e){handleComplete_flood(e,t)});e=t.getLibrary();o.loadManifest(e.properties.manifest)}function handleFileLoad_flood(e,t){var o=t.getImages();e&&"image"==e.item.type&&(o[e.item.id]=e.result)}function handleComplete_flood(e,t){var o=t.getLibrary(),n=t.getSpriteSheet(),a=e.target,r=o.ssMetadata;for(i=0;i<r.length;i++)n[r[i].name]=new createjs.SpriteSheet({images:[a.getResult(r[i].name)],frames:r[i].frames});exportRoot_flood=new o.Flood,(stage_flood=new o.Stage(canvas_flood)).addChild(exportRoot_flood),fnStartAnimation_flood=function(){createjs.Ticker.framerate=o.properties.fps,createjs.Ticker.addEventListener("tick",stage_flood)},AdobeAn_flood.makeResponsive(!0,"both",!0,1,[canvas_flood,anim_container_flood,dom_overlay_container_flood]),AdobeAn_flood.compositionLoaded(o.properties.id)}function init_house(){canvas_house=document.getElementById("canvas_house"),anim_container_house=document.getElementById("animation_container_house"),dom_overlay_container_house=document.getElementById("dom_overlay_container_house");var t=AdobeAn_house.getComposition("9C467AB24BF8423195F44663826E4B49"),e=t.getLibrary(),o=new createjs.LoadQueue(!1);o.addEventListener("fileload",function(e){handleFileLoad_house(e,t)}),o.addEventListener("complete",function(e){handleComplete_house(e,t)});e=t.getLibrary();o.loadManifest(e.properties.manifest)}function handleFileLoad_house(e,t){var o=t.getImages();e&&"image"==e.item.type&&(o[e.item.id]=e.result)}function handleComplete_house(e,t){var o=t.getLibrary(),n=t.getSpriteSheet(),a=e.target,r=o.ssMetadata;for(i=0;i<r.length;i++)n[r[i].name]=new createjs.SpriteSheet({images:[a.getResult(r[i].name)],frames:r[i].frames});exportRoot_house=new o.House,(stage_house=new o.Stage(canvas_house)).addChild(exportRoot_house),fnStartAnimation_house=function(){createjs.Ticker.framerate=o.properties.fps,createjs.Ticker.addEventListener("tick",stage_house)},AdobeAn_house.makeResponsive(!0,"both",!0,1,[canvas_house,anim_container_house,dom_overlay_container_house]),AdobeAn_house.compositionLoaded(o.properties.id)}function init_jobs(){canvas_jobs=document.getElementById("canvas_jobs"),anim_container_jobs=document.getElementById("animation_container_jobs"),dom_overlay_container_jobs=document.getElementById("dom_overlay_container_jobs");var t=AdobeAn_jobs.getComposition("9C467AB24BF8423195F44663826E4B49"),e=t.getLibrary(),o=new createjs.LoadQueue(!1);o.addEventListener("fileload",function(e){handleFileLoad_jobs(e,t)}),o.addEventListener("complete",function(e){handleComplete_jobs(e,t)});e=t.getLibrary();o.loadManifest(e.properties.manifest)}function handleFileLoad_jobs(e,t){var o=t.getImages();e&&"image"==e.item.type&&(o[e.item.id]=e.result)}function handleComplete_jobs(e,t){var o=t.getLibrary(),n=t.getSpriteSheet(),a=e.target,r=o.ssMetadata;for(i=0;i<r.length;i++)n[r[i].name]=new createjs.SpriteSheet({images:[a.getResult(r[i].name)],frames:r[i].frames});exportRoot_jobs=new o.Jobs,(stage_jobs=new o.Stage(canvas_jobs)).addChild(exportRoot_jobs),fnStartAnimation_jobs=function(){createjs.Ticker.framerate=o.properties.fps,createjs.Ticker.addEventListener("tick",stage_jobs)},AdobeAn_jobs.makeResponsive(!0,"both",!0,1,[canvas_jobs,anim_container_jobs,dom_overlay_container_jobs]),AdobeAn_jobs.compositionLoaded(o.properties.id)}function init_money(){canvas_money=document.getElementById("canvas_money"),anim_container_money=document.getElementById("animation_container_money"),dom_overlay_container_money=document.getElementById("dom_overlay_container_money");var t=AdobeAn_money.getComposition("9C467AB24BF8423195F44663826E4B49"),e=t.getLibrary(),o=new createjs.LoadQueue(!1);o.addEventListener("fileload",function(e){handleFileLoad_money(e,t)}),o.addEventListener("complete",function(e){handleComplete_money(e,t)});e=t.getLibrary();o.loadManifest(e.properties.manifest)}function handleFileLoad_money(e,t){var o=t.getImages();e&&"image"==e.item.type&&(o[e.item.id]=e.result)}function handleComplete_money(e,t){var o=t.getLibrary(),n=t.getSpriteSheet(),a=e.target,r=o.ssMetadata;for(i=0;i<r.length;i++)n[r[i].name]=new createjs.SpriteSheet({images:[a.getResult(r[i].name)],frames:r[i].frames});exportRoot_money=new o.Money,(stage_money=new o.Stage(canvas_money)).addChild(exportRoot_money),fnStartAnimation_money=function(){createjs.Ticker.framerate=o.properties.fps,createjs.Ticker.addEventListener("tick",stage_money)},AdobeAn_money.makeResponsive(!0,"both",!0,1,[canvas_money,anim_container_money,dom_overlay_container_money]),AdobeAn_money.compositionLoaded(o.properties.id)}$(document).ready(function(){init_benefit(),init_car(),init_commercial(),init_flood(),init_house(),init_jobs(),init_money()});